...
for i in range(len(theta)):
    ...
    aa = int(255*(abs(EV[0,0])**2))
    bb = int(255*(abs(EV[1,0])**2))
    cc = int(255*(abs(EV[2,0])**2))
    dd = int(255*(abs(EV[0,1])**2))
    ee = int(255*(abs(EV[1,1])**2))
    ff = int(255*(abs(EV[2,1])**2))
    gg = int(255*(abs(EV[0,2])**2))
    hh = int(255*(abs(EV[1,2])**2))
    ii = int(255*(abs(EV[2,2])**2))
